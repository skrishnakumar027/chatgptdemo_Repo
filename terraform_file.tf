...
Note: Please make sure to input your own values for `vpc_id` and `subnet_id`. Also ensure that you have the necessary permissions and the AMI is available in your AWS account