resource "aws_security_group" "dtcc_gpt_innovation_demo_security_group" {
...
resource "aws_instance" "dtcc_gpt_innovation_demo_instance" {
  ami = "ami-0a606d8395a538502"
  instance_type = "g4dn.xlarge"
  subnet_id = "subnet-0c983406b03e8b798"
  vpc_security_group_ids = [aws_security_group.dtcc_gpt_innovation_demo_security_group.id]
